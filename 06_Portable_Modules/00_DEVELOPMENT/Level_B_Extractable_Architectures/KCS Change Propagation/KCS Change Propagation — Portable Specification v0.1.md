# KCS Change Propagation — Portable Specification v0.1

**Version:** 0.1  
**Status:** SOURCE-EXTRACTED PORTABLE SPECIFICATION / PRE-TRANSFER-TEST  
...
These classifications are not a single precedence ladder. Several may coexist.
...
> **A coherent standalone portable specification has been extracted from a substantial source architecture.**

Not yet supported:

> **Independent functional transfer outside Concord has been demonstrated.**
...
Freeze **KCS Change Propagation — Blind Transfer Test 001** and its hidden expected-findings key before obtaining an independent response.

The first test should pressure:
- upstream correction;
- selective downstream review;
- stopping rules;
- material versus immaterial relations;
- alternatives;
- unknown dependencies;
- stale relations;
- supersession;
- dependency versus authority;
- sensitive visibility;
- cascade overload;
- further propagation only after material downstream state change.
