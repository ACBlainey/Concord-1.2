...
**Version:** 0.3  
**Status:** GRADUATION CANDIDATE / TWO-DOMAIN FUNCTIONAL TRANSFER / NOT YET RELEASED  
**Date:** September 2026
...
# 34. Cross-test validation record

KCS-BTT-001 tested v0.1 in a pharmaceutical R&D knowledge programme.
...
> **0 / 10 fundamental-failure indicators**

KCS-BTT-002 tested v0.2 in a long-lived aerospace engineering and mission-operations knowledge system.
...
> **0 / 12 fundamental-failure indicators**

The two domains materially differ in purpose, artefacts, time horizon, capability dependencies, access restrictions and downstream operational consequences.

> **CROSS-TEST CONVERGENCE OBSERVED**

The second test found no new kernel-level mechanism failure. Its residual findings were bounded specification/interface clarifications incorporated into this graduation candidate.

No third blind test is currently justified by unresolved transfer uncertainty.

# 35. Graduation-candidate status

Current status:

> **v0.3 — GRADUATION CANDIDATE**

> **TWO MATERIAL NON-CONCORD DOMAINS HAVE SHOWN FUNCTIONAL TRANSFER**

> **96 / 96 FROZEN PREDICTIONS MATERIALLY CONFIRMED**

> **0 / 22 FUNDAMENTAL-FAILURE INDICATORS OBSERVED**

> **NOT YET v1.0**

Graduation remains subject to formal PMEDG graduation review.

# 36. Graduation review questions

The graduation review should determine whether:

1. source extraction remains faithful;
2. the portable kernel is coherent and standalone;
3. BTT-001 and BTT-002 provide sufficient transfer evidence;
4. v0.3 incorporates only bounded evidence-supported clarifications;
5. KCS remains separate from authority, continuity and dependency propagation;
6. privacy, access, completeness and capability boundaries remain explicit;
7. any unresolved issue is a release blocker;
8. another blind test would materially reduce remaining uncertainty.
