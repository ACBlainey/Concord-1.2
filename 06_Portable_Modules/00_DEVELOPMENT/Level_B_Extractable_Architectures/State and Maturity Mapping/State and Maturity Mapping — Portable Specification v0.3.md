# State and Maturity Mapping — Portable Specification v0.3

**Version:** 0.3  
**Development level:** Level B — Extractable Architectures  
**Method:** PMEDG v1.2  
**Status:** CONVERGENCE SPECIFICATION / TWO FUNCTIONAL TRANSFERS / GRADUATION PREPARATION  
**Date:** September 2026
...
Audit v0.3 against BTT-001, BTT-002 and the Cross-Test Convergence Review to confirm that:

- every material v0.3 addition is evidence-supported;
- no tested invariant has been weakened;
- no unsupported authority or universal criterion has been introduced;
- the specification remains standalone and non-Concord-dependent.

If that audit passes, prepare the portable package and graduation review.

A third blind transfer test is not currently required. BTT-003 should be triggered only if v0.3 introduces a materially new mechanism, changes a tested invariant, or graduation review exposes a material unresolved transfer question.
