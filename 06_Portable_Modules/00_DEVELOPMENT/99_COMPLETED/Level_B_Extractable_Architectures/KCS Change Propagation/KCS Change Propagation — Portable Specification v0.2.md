# KCS Change Propagation — Portable Specification v0.2
...
> **A coherent standalone portable specification has been extracted from a substantial source architecture and has demonstrated one independent functional transfer outside Concord.**

KCP-BTT-001 used a regional hospital laboratory and clinical-reporting infrastructure.
...
The independently exposed findings concerned temporal scope, non-transforming conduits, batch/instance modelling, host materiality/freshness thresholds, high-consequence unknowns, document relation semantics, alternative verification and classification coexistence. v0.2 incorporates bounded clarifications only.
...
Freeze **KCS Change Propagation — Blind Transfer Test 002** and its hidden expected-findings key before obtaining an independent response.

The second test should use a materially different non-Concord domain and pressure the v0.2 clarifications as well as the unchanged core mechanism.
