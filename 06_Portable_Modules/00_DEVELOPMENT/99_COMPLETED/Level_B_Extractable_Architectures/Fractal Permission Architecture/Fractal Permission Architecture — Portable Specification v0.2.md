# Fractal Permission Architecture — Portable Specification v0.2

**Version:** 0.2  
**Status:** DEVELOPMENT SPECIFICATION / POST-BTT-001 BOUNDED REVISION / NOT YET GRADUATED  
...
Qualification, competence and role-validity predicates are external inputs unless the implementation explicitly defines them. FPA must not invent competence merely to make a permission claim succeed.
...
FPA-BTT-001 tested v0.1 in a materially non-Concord community fabrication workshop.

Independent result:

> **FPA-T3 — FUNCTIONAL TRANSFER**

Frozen-key evaluation:

> **26/26 FROZEN PREDICTIONS MATERIALLY CONFIRMED**

> **NO FUNDAMENTAL FAILURE DETECTED**

The independent tester exposed bounded ambiguities concerning conflict routing, implied-permission provenance, external competence definitions, contested function boundaries, anti-bureaucracy proportionality, machine/human divergence remediation, emergency termination, multidimensional status semantics and underlying-rule legitimacy. v0.2 incorporates only bounded clarifications responding to those findings.

## 43. Development next step

Freeze **Fractal Permission Architecture — Blind Transfer Test 002** before obtaining an independent response.

The second test should use a materially different non-Concord domain and pressure:
