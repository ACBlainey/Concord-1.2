# Fractal Permission Architecture — Portable Specification v0.3
...
A third blind test is not automatically required because v0.3 is a bounded clarification revision. Add another test only if the graduation review identifies a material unresolved transfer risk or a later revision introduces a materially new mechanism.
