...
STRA should permit periodic/backstop review of the trigger definition itself.
...
Implementations should support bounded cascade controls such as:
...
Freeze a blind transfer test before obtaining the independent response.
