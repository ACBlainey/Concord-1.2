# Reality Trees — A Portable Method for Weighted Possibility-Space Reasoning

**Author:** Alexander C. Blainey  
**Project of origin:** The Concord Framework  
**Module status:** PORTABLE MODULE / SPECIFICATION-LEVEL GRADUATED  
...
The module was source-extracted from the later Concord architecture and revised to restore the broader originating concept supplied by the author. RT-BTT-002 independently transferred the recovered-scope method to a non-Concord choice problem using only the standalone specification and frozen test brief. The result was **RT2-T2 — TRANSFER SUCCESS WITH MINOR REVISION**. The supported usability revisions were incorporated before this v1.0 release.
...
> **Portable-module graduation ≠ empirical validation.**


---

## 21. Provenance and release status

Reality Trees originated in Alexander C. Blainey's broader reasoning work and was later developed within the Concord Framework. During portable-module extraction, originating background supplied by the author recovered a broader general-purpose conception that had become partly obscured by later specialised Concord applications.

The development record, source-recovery audit, blind-transfer materials and graduation review are preserved under:

`06_Portable_Modules/00_DEVELOPMENT/Level_A_Complete_Portable_Protocols/Reality Trees/`

The portable release is usable independently of those records.

**Release status:** SPECIFICATION-LEVEL GRADUATED.

This status means that the method has been source-resolved, operationally specified and successfully transferred in a bounded independent AI-instance test. It does not imply empirical superiority or demonstrated benefit across users, domains or populations.
